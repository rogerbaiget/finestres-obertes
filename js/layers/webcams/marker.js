...
// Single source of truth for what a webcam dot looks like — both the real map marker
...
export function getWebcamAppearance(cam){
  return {
...
export function createWebcamMarkerElement(cam){
  const { color, size, boxShadow, opacity } = getWebcamAppearance(cam);
